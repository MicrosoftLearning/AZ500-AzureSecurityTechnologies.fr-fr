...
6. Sous l’onglet Ressources, sélectionnez **+ Ajouter des ressources** et cochez la case **Activer les points de terminaison de collecte de données.** Dans le modèle Sélectionner une étendue, cochez **AZ500LAB131415** et cliquez sur **Appliquer.**
