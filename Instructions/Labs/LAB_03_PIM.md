---
lab:
  title: "3\_:\_Microsoft\_Entra Privileged Identity Management"
  module: Module 01 - Manage Identity and Access
---

# Labo 3 : Microsoft Entra Privileged Identity Management
...
- Configurer l’activation du rôle Lecteur global pour exiger une approbation de l’utilisateur Microsoft Entra ID aaduser3
...
> Avant de continuer, vérifiez que vous avez terminé le labo 2 : MFA, accès conditionnel et Microsoft Entra Identity Protection. Vous aurez besoin du locataire Microsoft Entra, d’AdatumLab500-04 et des comptes d’utilisateur aaduser1, aaduser2 et aaduser3.
...
## Diagramme Microsoft Entra Privileged Identity Management
...
1. Connectez-vous au portail Azure à l’adresse **`https://portal.azure.com/`**.
    ...
    >**Remarque** : assurez-vous d’être connecté au locataire Microsoft Entra **AdatumLab500-04**. Vous pouvez utiliser le filtre **Annuaire + abonnement** pour basculer entre les locataires Microsoft Entra. Vérifiez que vous êtes connecté en tant qu’utilisateur avec le rôle Administrateur général.
...
10. Dans le volet **Mes rôles \| Rôles Microsoft Entra ID**, basculez vers l’onglet **Affectations actives**. Vous remarquez que le rôle **Administrateur de facturation** est **activé**.
...
9. Revenez dans le volet **Mes rôles \| Rôles Microsoft Entra ID**, cliquez sur l’onglet **Affectations actives** et notez que la liste des **Affectations actives** inclut **Administrateur de la sécurité**, mais pas le rôle **Lecteur général**.
...
- Tâche 1 : configurer des alertes de sécurité pour les rôles Microsoft Entra ID dans PIM
...
8. Dans le volet **Licences** | Vue d’ensemble, cliquez sur **Tous les produits**, cochez la case **Microsoft Entra ID P2** et cliquez dessus pour l’ouvrir.
    ...
    >**Remarque** : le Labo 2 - Exercice 2 - Tâche 4 **Affecter des licences Microsoft Entra ID P2 aux utilisateurs Microsoft Entra** consistait à affecter les licences Premium aux utilisateurs **aaduser1, aaduser2 et aaduser3**. Veillez à supprimer ces licences des utilisateurs affectés.

9. Dans le volet **Microsoft Entra ID P2 - Utilisateurs sous licence**, cochez les cases des comptes d’utilisateur auxquels vous avez attribué des **licences Microsoft Entra ID P2**. Cliquez sur **Supprimer la licence** dans le volet supérieur et, lorsque vous êtes invité à confirmer, sélectionnez **Oui**.
...
14. Revenez au volet **Supprimer le répertoire AdatumLab500-04**, puis cliquez sur **Supprimer**.
    ...
    >**Remarque** : si vous n’êtes toujours pas en mesure de supprimer le locataire et que vous recevez l’erreur **Supprimer tous les abonnements basés sur une licence**, cela peut être dû à tous les abonnements qui ont été liés au locataire. Ici, la **Licence gratuite P2** peut générer l’erreur de validation. La suppression de l’abonnement d’évaluation de la licence P2 à l’aide de l’ID d’administrateur général de l’administrateur M365>> **Vos produits** et du portail **Business Store** résout ce problème. Notez également que la suppression du locataire prend plus de temps. Vérifiez la date de fin de l’abonnement, une fois après la fin de la période d’évaluation, revisitez Microsoft Entra ID, puis essayez de supprimer le locataire.    
