...
1. Dans l’onglet **Options de base** du volet **Créer un réseau virtuel** , spécifiez les paramètres suivants (conservez les valeurs par défaut pour les autres) :
...
1. Dans l’onglet **Vérifier + créer** du volet **Créer un réseau virtuel** , notez le message **Échec de validation**. 
...
1. Fermez le volet **Attribution de stratégie**. Dans le volet **Créer un réseau virtuel**, cliquez sur l’onglet **Options de base**, puis, dans la liste déroulante **Région**, sélectionnez **Royaume-Uni Sud**.
