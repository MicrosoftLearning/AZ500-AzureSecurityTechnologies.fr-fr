---
lab:
  title: "5\_:\_groupes de sécurité réseau et groupes de sécurité des applications"
  module: Module 02 - Implement Platform Protection
---

# Labo 5 :groupes de sécurité réseau et groupes de sécurité des applications
...
3. Dans le volet **myVMWeb**, dans la section **Mise en réseau**, cliquez sur **Paramètres réseau**, puis dans le volet **Paramètres réseau \| myVMWeb**, cliquez sur l’onglet **Groupes de sécurité d’application**.
...
6. Dans le volet **myVMMgmt**, dans la section **Mise en réseau**, cliquez sur **Paramètres réseau**, puis dans le volet **Paramètres réseau \| myVMMgmt**, cliquez sur l’onglet **Groupes de sécurité d’application**.
